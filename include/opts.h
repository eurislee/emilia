...
#define OPT_COLUMNS_IDX 12
    [OPT_COLUMNS_IDX] = { "columns", required_argument, 0, 0 },

#define OPT_DECORATIONS 13
    [OPT_DECORATIONS] = { "decorations", required_argument, 0, 0 },

#define OPT_INC_WIN_RESIZE 14
    [OPT_INC_WIN_RESIZE] = { "incremental-resize", required_argument, 0, 0 },

#define OPT_DECORATION_THEME 15
    [OPT_DECORATION_THEME] = { "decoration-theme", required_argument, 0, 0 },

#define OPT_HIDE_POINTER 16
...
static const char* long_options_descriptions[][2] = {
    ...
    [OPT_INC_WIN_RESIZE] = { arg_bool, "Use cell size as window resize increments" },

    [OPT_DECORATIONS] = { arg_name, "Window decoration type: full, minimal, none (default: full)" },
    [OPT_DECORATION_THEME] = { arg_name,
                               "Window decoration theme: none, dark, auto (default: auto)" },
